    ...
    <>
          ...
          <div className="mx-auto max-w-3xl text-base/7">
            <div className={`${styles.content} mb-5`}>
              ...
              <p className="mt-2 text-lg/8">
                「アプリ名」に関するご質問やご要望などがございましたら、お気軽にお問い合わせください。
      ...
      >
        <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
          ...
          >
            <div
              className={`pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg shadow-lg ring-1 ring-opacity-5 mt-16`}
            >
              <div className="p-4">
